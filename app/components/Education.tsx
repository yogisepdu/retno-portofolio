        ...
        >
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            <div className="rounded-2xl border border-white/10 bg-slate-950/40 p-5">
              ...
              <p className="mt-1 text-2xl font-bold">3.61 / 4.00</p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-slate-950/40 p-5">
              <p className="text-sm text-slate-400">Focus Areas</p>
              <p className="mt-1 text-sm leading-6 text-slate-300">
                Programming, jaringan komputer, basis data, aplikasi
                perkantoran, dan UI.
              </p>
            </div>
          </div>
          ...
          <p className="mt-6 text-sm leading-7 text-slate-400">
            Aktif dalam organisasi Himpunan Mahasiswa Teknik Informatika,
            melakukan praktik kerja lapangan, serta mengikuti pelatihan dan
            seminar terkait teknologi informasi, aplikasi perkantoran, web
            development, dan desain grafis.
          </p>
        </motion.div>
      </div>
    </section>
